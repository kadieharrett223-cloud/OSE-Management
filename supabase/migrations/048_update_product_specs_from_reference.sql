...
UPDATE price_list_items SET description = 'Gold series 2 post base plate, 12,000 lb capacity, 115" H X 153" W, open carriage, single lock release, secondary lock, 115" x 156", pullies, cables, and hoses to be factory installed, 3 stage arms, 3 stage adjustible foot, 3.5" truck adapter set, 110v 60hz 2.2kw power unit, palletize power unit seperately', weight_lbs = 1380 WHERE item_no = '2PBP-12';
UPDATE price_list_items SET description = 'Gold series 2 post base plate, 10,000 lb capacity, open carriage, single lock release, secondary lock, 110" H X 137" W, pullies, cables, and hoses to be factory installed, 3 stage arms, 3 stage adjustible foot, 3.5" truck adapter set, 110v 60hz 2.2kw power unit, palletize power unit seperately', weight_lbs = 1380 WHERE item_no = '2PBPXW-10';
...
UPDATE price_list_items SET description = 'Gold Series 2 post clear floor, 10,000 lb capacity 153" H X 135" W, chain drive, 3 stage arms, 3 stage foot, single lock release, secondary lock, pullies, cables, and hoses to be factory installed, open carriage, 3.5" truck adapter set, 110v 60hz 2.2 kw, Palletize power unit seperately', weight_lbs = 1595 WHERE item_no = '2PCFXL-10';
UPDATE price_list_items SET description = 'Gold Series 2 post clear floor car lift, 12,000 lb capacity, 174" x 156", open carriage, 3 stage arms, 3 stage foot, single lock release, secondary lock, pullies, cables, and hoses to be factory installed, 3.5" truck adapter set, 110v 60hz 2.2 kw, palletize power unit seperately', weight_lbs = 2085 WHERE item_no = '2PCFHD-12';
UPDATE price_list_items SET description = 'Gold Series 2 post clear floor car lift maintenance lift, 15,000 lb capacity, sealed height 190" W, 168.5", chain drive, open carriage, 3 stage arms, 3 stage adjustible foot, 3.5" truck adapter set, 110v 60hz 2.2 kw, palletize power unit seperately', weight_lbs = 2325 WHERE item_no = '2PCFHD-15';

-- 2-POST DIRECT DRIVE UNITS
UPDATE price_list_items SET description = 'Gold Series 2 post clear floor symmetric / asymmetric post 10,000 lb. capacity, 153" H X 145" W, direct drive, open carriage, 3 stage arms, 3 stage foot, single lock release, secondary lock, pullies, cables, and hoses to be factory installed, 3.5" truck adapter set, 110v 60hz 2.2 kw, palletize power unit seperately', weight_lbs = 1565 WHERE item_no = '2PDDA-10';
