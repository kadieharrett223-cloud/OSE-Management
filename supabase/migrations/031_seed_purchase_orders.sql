...
VALUES
  ('C-195', 'FB', '2025-12-16', '2026-03-14', 'SUBMITTED', 0),
  ('C-197', 'HIKER', '2025-11-11', '2026-02-23', 'SUBMITTED', 0),
  ('C-198', 'HL', '2025-11-20', '2026-03-16', 'SUBMITTED', 0),
  ('C-199', 'HL', '2025-11-19', '2026-02-24', 'SUBMITTED', 0),
  ('C-201', 'HL', '2025-11-29', NULL, 'SUBMITTED', 0),
  ('C-202', 'HL', '2025-11-30', '2026-02-21', 'SUBMITTED', 0),
  ('C-203', 'HL', '2025-11-30', '2026-03-03', 'SUBMITTED', 0),
  ('C-205', 'FB', '2025-12-17', '2026-03-14', 'SUBMITTED', 0),
  ('C-206', 'HL', '2025-12-05', NULL, 'SUBMITTED', 0),
  ('C-207', 'HL', '2025-12-05', '2026-02-23', 'SUBMITTED', 0),
  ('C-208', 'HIKER', '2025-12-05', NULL, 'SUBMITTED', 0),
  ('C-209', 'HIKER', '2025-12-05', NULL, 'SUBMITTED', 0),
  ('C-210', 'HIKER', '2025-12-05', NULL, 'SUBMITTED', 0),
  ('C-211', 'YIZ', '2025-12-15', '2026-03-02', 'SUBMITTED', 0),
  ('C-212', 'HL', '2025-12-20', NULL, 'SUBMITTED', 0),
  ('C-213', 'HL', '2025-12-20', NULL, 'SUBMITTED', 0),
  ('C-214', 'HL', '2025-12-23', NULL, 'SUBMITTED', 0),
  ('C-215', 'HL', '2025-12-25', NULL, 'SUBMITTED', 0),
  ('C-216', 'YIZ', '2025-12-26', NULL, 'SUBMITTED', 0),
  ('C-217', 'HL', '2026-01-07', NULL, 'SUBMITTED', 0),
  ('C-218', 'YIZ', '2026-01-06', NULL, 'SUBMITTED', 0),
  ('C-219', 'HL', '2026-01-13', NULL, 'SUBMITTED', 0),
  ('C-220', 'YIZ', '2026-01-13', NULL, 'SUBMITTED', 0),
  ('C-221', 'HL', '2026-01-30', NULL, 'SUBMITTED', 0);
