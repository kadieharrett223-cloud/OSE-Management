-- Modify trigger to preserve manually set list_price values
...
-- Recreate function with logic to preserve manual list_price
...
BEGIN
  ...
  -- 6) list_price: Only calculate if NULL (preserve manually set values)
  -- If list_price is being explicitly set (not NULL and different from calculated), keep it
